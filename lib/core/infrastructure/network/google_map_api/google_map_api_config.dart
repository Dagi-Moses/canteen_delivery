...
class GoogleMapApiConfig {
  ...
  // You should also restrict your y by limiting which app can use it (Application restrictions)
  ...
  // You can set one application restriction per key, so you need to create a separate y for each app, and for each platform on which that app is available.
